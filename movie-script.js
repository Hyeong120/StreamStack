...
async function loadMovies() {
        ...
        document.getElementById('main-content').innerHTML = `
        <iframe  class="main-watch" id="main-watch" src="https://vidsrc-embed.ru/embed/movie/${ids}" sandbox="allow-same-origin allow-scripts" allow="fullscreen; encrypted-media;"></iframe>
